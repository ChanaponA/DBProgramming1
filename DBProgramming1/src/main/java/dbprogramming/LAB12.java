...
public class LAB12 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            preparedStatement.setString(1, "65130500005");
            preparedStatement.setString(2, "Kundids");
            preparedStatement.setString(3, "Khawmeesri");
            preparedStatement.setString(4, "kundids.khaw@mail.kmutt.ac.th");
